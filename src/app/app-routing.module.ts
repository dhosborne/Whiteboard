...
const appRoutes: Routes = [
    ...
    {path: 'shelters/:id', component: ShelterDetailsComponent, canActivate: [AuthGuard], data: {title: 'New Shelter'}},
    ...
    {path: 'issues/:id', component: IssueDetailsComponent, canActivate: [AuthGuard], data: {title: 'Details'}},
